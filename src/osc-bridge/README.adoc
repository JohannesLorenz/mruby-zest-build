...
Currently 'schema/zyn-fusion.json' is assumed to be the only valid
OSC schema. Custom paths should be usable and for embedding purposes
it should be possible to load directly from a preloaded const char *.
